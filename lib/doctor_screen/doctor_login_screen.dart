...
import 'package:register/doctor_screen/doctor_tabs_screen.dart';
...
class DoctorLoginScreen extends StatefulWidget {
  static const String screenRoute = 'doctor_login_screen';
  const DoctorLoginScreen({Key? key}) : super(key: key);

  @override 
    State<StatefulWidget> createState() => InitState();
}
  class InitState extends State<DoctorLoginScreen> {
    @override
      ...
      children: [
        ...
        Container(
           margin: EdgeInsets.only(left: 20, right: 20, top: 70),
            ...
            child: TextButton(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>  DoctorTabsScreen()));},
