/*doctor_tabs_screen.dart */
// ignore_for_file: prefer_const_constructors, deprecated_member_use

import 'package:flutter/gestures.dart';
import 'package:register/doctor_screen/doctor_notifications_screen.dart';
...
import 'dschedule_screen.dart';
import 'dsearch_screen.dart';
...
class DoctorTabsScreen extends StatefulWidget {
  static const String screenRoute = 'doctor_tabs_screen';
  const DoctorTabsScreen({Key? key}) : super(key: key);

  @override
  State<DoctorTabsScreen> createState() => _DoctorTabsScreenState();
}
      ...
      drawer: Drawer(
        ...
        child: Column(
          ...
          UserAccountsDrawerHeader(
           ...
           ListTile(title: FlatButton(onPressed: () {Navigator.pushReplacementNamed(context, SelectionScreen.screenRoute);},child: Text("الرئيسية")), leading: Icon(Icons.home),),
